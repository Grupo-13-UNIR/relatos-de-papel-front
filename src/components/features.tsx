...
const features = [
  {
    ...
    description:
      'Encuentra libros por título, autor, género o palabras clave con filtros potentes.',
  },
  {
    icon: ShoppingCart,
    title: 'Carrito Intuitivo',
    description:
      'Gestiona tus compras fácilmente. Añade, modifica o elimina productos antes de pagar.',
  },
  {
    icon: CreditCard,
    title: 'Pagos Seguros',
    ...
    <section className="py-20 md:py-32 bg-muted/30 h-[95vh]">
      <div className="container mx-auto px-4">
        ...
        <p className="text-xl text-muted-foreground pt-8 pb-24 px-4">
          Una plataforma completa diseñada para hacer tu experiencia de compra simple, segura y
          satisfactoria.
        </p>
